...
"""
Output:
    CAGR = 0.11808656812954132
    sharpe = 0.5457030233433425
    Maximum drawdown = 0.27012754796108746
...
The cumulative returns of the approach (in blue) consistently surpassed those 
of the index (in orange) across the timeframe, as illustrated in the attached plot.
